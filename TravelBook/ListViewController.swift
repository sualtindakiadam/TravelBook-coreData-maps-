...
//  TravelBook
//
//  Created by Semih Kalaycı on 18.08.2021.
//
...
class ListViewController: UIViewController , UITableViewDelegate, UITableViewDataSource {
    ...
    @IBOutlet weak var savedListLV: UITableView!
    ...
    override func viewDidLoad() {
        ...
        savedListLV.delegate = self
        savedListLV.dataSource = self
